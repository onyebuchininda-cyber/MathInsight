...
st.markdown("Selamat datang di **MathInsight**. Chatbot ini membantu guru menganalisis bukti belajar siswa dengan menghubungkannya ke PCK dan konteks MTSS secara objektif.")
        ...
        for col_name in collections:
            try:
                ...
                if results['documents'][0]:
                    ...
                    retrieved_data.append({"Sumber": SOURCE_MAP.get(col_name, col_name), "Informasi": doc, "Detail": clean_metadata(meta)})
